...
import reactivefeign.webclient.client.RibbonPublisherClient;
    ...
    public static class Builder<T> extends WebReactiveFeign.Builder<T> {
        ...
        protected PublisherClientFactory buildReactiveClientFactory() {
            ...
            return methodMetadata -> {
                ...
                return new RibbonPublisherClient(loadBalancerCommandFactory.apply(serviceName), publisherClient);
            };
        }
